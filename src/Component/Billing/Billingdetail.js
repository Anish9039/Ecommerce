...
const Billingdetail = () => {
  return (
    <div className="w-full flex flex-col gap-9 p-4 justify-between items-center">
      {/* Billing Details */}
      <div className="flex flex-col justify-between items-center gap-9">
        <h2 className="text-2xl md:text-4xl font-medium leading-none text-black">Billing Details</h2>
      </div>
